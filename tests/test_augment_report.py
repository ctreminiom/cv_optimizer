...
def test_parse_job_captured_via_pydantic_class_when_name_lost():
    job = _make("JobPosting", {"title": "Sr PM", "company": "Apply",
...
def test_parse_cv_captured_from_raw_json():
    cv = _TaskOut(name="parse_cv_task", pydantic=None,
...
def test_competitor_profile_captured_when_present():
    comp = _make("CompetitorProfile", {"summary": "strong rival",
                                        "differentiators": ["native Asana"]})
